...
config_model = {
    ...
    "sources": {
        "riv": [
            {"stage": "top", "cond": 100, "depth": 1.5, "geometry": os.path.join("input", "vectors", "zones_small_river.shp"), "bname": "zn_"},
            {"stage": "top", "cond": 1000, "depth": 5, "geometry": os.path.join("input", "vectors", "zones_river.shp"), "bname": "zn_"},
        ],
        "drn": [
            {"geometry": "all", "head": "top", "cond": 10000, "layers": [0]},
        ]
    },
    "parameters": {
    ...
    "observations": {
        "wells": os.path.join("input", "vectors", "well_regime_sort2.csv"),
    }
}
