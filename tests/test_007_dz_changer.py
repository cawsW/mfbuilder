...
config_model = {
    ...
    "sources": {
        "chd": {1: [
            {"head": os.path.join("input", "raster", "river_stages_dz_pred.tif"), "layers": [1],
             "geometry": os.path.join("input", "vector", "zones_flood_chd.shp")},
            {"head": os.path.join("input", "raster", "river_stages_dz_pred_5m.tif"), "layers": [1],
             "geometry": os.path.join("input", "vector", "small_rivers.shp")},
            {"head": os.path.join("input", "raster", "river_stages_dz_pred_3m.tif"), "layers": [1],
             "geometry": os.path.join("input", "vector", "canal.shp")},
        ],
            0: [
        ...
        # ],
        # 1: [{
        #     "stage": os.path.join("input", "raster","river_stages_dz_pred_3m.tif"), "cond": 50, "depth": 1.5,
        #     "geometry": os.path.join("input", "vector", "small_rivers.shp"), "bname": "zn_", "layers": [1]}
        # ]},
        "wel": {1: [
...
a.base.model.remove_package("RIV")
a.run()
