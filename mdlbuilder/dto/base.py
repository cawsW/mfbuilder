...
from mdlbuilder.dto.types import EngineType, TimeUnitType, Scalar
from mdlbuilder.dto.grid import GridConfig
from mdlbuilder.dto.packages import SourcesSinksConfig
from mdlbuilder.dto.packages_flow import FlowPackagesConfig
from mdlbuilder.dto.observations import ObservationsConfig
from mdlbuilder.dto.output import OutputsConfig
...
class TransientConfig(BaseModel):
    perlen: Annotated[list[Scalar] | Scalar, Field(gt=0, default=[1], description="Длина stress period")]
    nstp: Annotated[list[int] | int, Field(gt=0, default=[1], description="Количество шагов на stress period")]
    tsmult: Annotated[list[int] | Scalar, Field(gt=0, default=[1], description="Множитель шага на временном шаге")]
    start_datetime: Annotated[date | None, Field(default=None, description="Начальная дата и время")]
    steady: Annotated[
        list[bool], Field(default=[True], description="Список стационарных и нестационарных stress period")]
